...
// ArticleImagesColumns defines and stores column names for table article_images.
...
// articleImagesColumns holds the columns for table article_images.
...
func NewArticleImagesDao() *ArticleImagesDao {
